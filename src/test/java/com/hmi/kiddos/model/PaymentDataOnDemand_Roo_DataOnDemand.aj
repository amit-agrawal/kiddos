...
privileged aspect PaymentDataOnDemand_Roo_DataOnDemand {
    ...
    public void PaymentDataOnDemand.setPaymentMedium(Payment obj, int index) {
        PaymentMedium paymentMedium = PaymentMedium.class.getEnumConstants()[0];
        obj.setPaymentMedium(paymentMedium);
    }
    
    public void PaymentDataOnDemand.setReceiptNumber(Payment obj, int index) {
    ...
    public void PaymentDataOnDemand.setTransactionNumber(Payment obj, int index) {
