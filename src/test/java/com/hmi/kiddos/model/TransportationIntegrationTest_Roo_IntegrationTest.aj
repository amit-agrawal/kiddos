...
privileged aspect TransportationIntegrationTest_Roo_IntegrationTest {
    
    declare @type: TransportationIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: TransportationIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: TransportationIntegrationTest: @Transactional;
    
    @Autowired
    TransportationDataOnDemand TransportationIntegrationTest.dod;
    
    @Test
    public void TransportationIntegrationTest.testCountTransportations() {
    ...
    @Test
    public void TransportationIntegrationTest.testFindTransportation() {
    ...
    @Test
    public void TransportationIntegrationTest.testFindAllTransportations() {
        Assert.assertNotNull("Data on demand for 'Transportation' failed to initialize correctly", dod.getRandomTransportation());
        long count = Transportation.countTransportations();
    ...
    @Test
    public void TransportationIntegrationTest.testFindTransportationEntries() {
        Assert.assertNotNull("Data on demand for 'Transportation' failed to initialize correctly", dod.getRandomTransportation());
        long count = Transportation.countTransportations();
    ...
    @Test
    public void TransportationIntegrationTest.testFlush() {
        Transportation obj = dod.getRandomTransportation();
        Assert.assertNotNull("Data on demand for 'Transportation' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Transportation' failed to provide an identifier", id);
    ...
    @Test
    public void TransportationIntegrationTest.testMergeUpdate() {
        Transportation obj = dod.getRandomTransportation();
        Assert.assertNotNull("Data on demand for 'Transportation' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Transportation' failed to provide an identifier", id);
    ...
    @Test
    public void TransportationIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'Transportation' failed to initialize correctly", dod.getRandomTransportation());
    ...
    @Test
    public void TransportationIntegrationTest.testRemove() {
        Transportation obj = dod.getRandomTransportation();
        Assert.assertNotNull("Data on demand for 'Transportation' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Transportation' failed to provide an identifier", id);
