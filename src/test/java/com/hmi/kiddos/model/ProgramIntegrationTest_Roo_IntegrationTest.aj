...
import com.hmi.kiddos.model.ProgramIntegrationTest;
...
privileged aspect ProgramIntegrationTest_Roo_IntegrationTest {
    
    declare @type: ProgramIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: ProgramIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    ...
    @Test
    public void ProgramIntegrationTest.testFindProgram() {
    ...
    @Test
    public void ProgramIntegrationTest.testFlush() {
        Program obj = dod.getRandomProgram();
        Assert.assertNotNull("Data on demand for 'Program' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Program' failed to provide an identifier", id);
