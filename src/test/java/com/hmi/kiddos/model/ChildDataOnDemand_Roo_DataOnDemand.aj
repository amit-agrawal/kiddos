...
privileged aspect ChildDataOnDemand_Roo_DataOnDemand {
    ...
    public void ChildDataOnDemand.setAddress(Child obj, int index) {
    ...
    public void ChildDataOnDemand.setAllergy(Child obj, int index) {
    ...
    public void ChildDataOnDemand.setBloodGroup(Child obj, int index) {
    ...
    public void ChildDataOnDemand.setDob(Child obj, int index) {
        Calendar dob = Calendar.getInstance();
        obj.setDob(dob);
    }
    
    public void ChildDataOnDemand.setEmailOne(Child obj, int index) {
    ...
    public void ChildDataOnDemand.setEmailThree(Child obj, int index) {
    ...
    public void ChildDataOnDemand.setEmailTwo(Child obj, int index) {
    ...
    public void ChildDataOnDemand.setFatherName(Child obj, int index) {
    ...
    public void ChildDataOnDemand.setFatherOrganization(Child obj, int index) {
    ...
    public void ChildDataOnDemand.setFirstName(Child obj, int index) {
    ...
    public void ChildDataOnDemand.setGender(Child obj, int index) {
    ...
    public void ChildDataOnDemand.setMiddleName(Child obj, int index) {
    ...
    public void ChildDataOnDemand.setMotherName(Child obj, int index) {
    ...
    public void ChildDataOnDemand.setMotherOrganization(Child obj, int index) {
    ...
    public void ChildDataOnDemand.setNationality(Child obj, int index) {
    ...
    public void ChildDataOnDemand.setNotes(Child obj, int index) {
    ...
    public void ChildDataOnDemand.setPhoneFather(Child obj, int index) {
    ...
    public void ChildDataOnDemand.setPhoneHome(Child obj, int index) {
    ...
    public void ChildDataOnDemand.setPhoneMother(Child obj, int index) {
    ...
    public void ChildDataOnDemand.setPincode(Child obj, int index) {
