...
import com.hmi.kiddos.controllers.AdmissionController;
...
privileged aspect AdmissionController_Roo_Controller {
    
    @RequestMapping(method = RequestMethod.POST, produces = "text/html")
    public String AdmissionController.create(@Valid Admission admission, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String AdmissionController.createForm(Model uiModel) {
    ...
    public String AdmissionController.show(@PathVariable("id") Long id, Model uiModel) {
    ...
    public String AdmissionController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, @RequestParam(value = "sortFieldName", required = false) String sortFieldName, @RequestParam(value = "sortOrder", required = false) String sortOrder, Model uiModel) {
    ...
    public String AdmissionController.update(@Valid Admission admission, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, admission);
    ...
    public String AdmissionController.updateForm(@PathVariable("id") Long id, Model uiModel) {
        populateEditForm(uiModel, Admission.findAdmission(id));
        return "admissions/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String AdmissionController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    void AdmissionController.addDateTimeFormatPatterns(Model uiModel) {
    ...
    void AdmissionController.populateEditForm(Model uiModel, Admission admission) {
    ...
    String AdmissionController.encodeUrlPathSegment(String pathSegment, HttpServletRequest httpServletRequest) {
